...
Step 1: Create a function a list of species given the data, location, and trophic level (will be used later to fill the matrix)
...
Below is exploratory code from trying to figure out how to analyse each matrix specifically. This is automated further down in the file
